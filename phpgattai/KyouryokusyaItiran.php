...
if(isset($_POST["edit"])){
	...
	header("Location:KyouryokusyaEdit.php");
	exit();
}
...
try {
	$pdo = new PDO($dsn, $db['user'], $db['pass'], array(PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION));
        ...
        $stmt = $pdo->query('SELECT * FROM KyouryokusyaUserData');
...
history.pushState({}, "", "KyouryokusyaItiran.php")
...
<form action="KyouryokusyaSignUp.php">
<div><input id="add" type="submit" value="協力者の追加"></div>
</form>
