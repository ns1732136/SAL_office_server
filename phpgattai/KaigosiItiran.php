...
if(isset($_POST["edit"])){
	...
	header("Location:KaigosiEdit.php");
	exit();
}
...
try {
	$pdo = new PDO($dsn, $db['user'], $db['pass'], array(PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION));
        ...
        $stmt = $pdo->prepare('SELECT * FROM SiyakusyoKaigoUserData WHERE bunrui=2');
...
history.pushState({}, "", "KaigosiItiran.php")
...
<form action="KaigosiSignUp.php">
<div><input id="add" type="submit" value="介護師の追加"></div>
</form>
